package com.example.reste.repository;
...
public interface IRepositorioNota extends JpaRepository<Nota, Serializable>, PagingAndSortingRepository<Nota, Serializable> {
